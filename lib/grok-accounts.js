...
/**
 * Load accounts from a pi-style auth.json (`xai-oauth` provider entry).
 * @param {string} filePath
 * @param {string} [providerKey="xai-oauth"]
 * @returns {object[]}
 */
export function loadGrokAccountsFromPiAuth(filePath, providerKey = "xai-oauth") {
