...
export function printHelp() {
	console.log(`${PRIMARY_CMD} - Manage and monitor OpenAI Codex, Claude, and Factory accounts
Version: ${getPackageVersion()}

Usage:
  ${PRIMARY_CMD} <namespace> [command] [options]
  ${PRIMARY_CMD} [label]                       Check quota for all accounts (Codex + Claude + Factory)
...
Examples:
  ${PRIMARY_CMD}                   Check quota for all accounts (Codex + Claude + Factory)
